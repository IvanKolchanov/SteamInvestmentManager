...
class CurrencyExchangeDialog : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        if (exchangeModeDefault) setDefaultText(text1, text2, text3)
        else setAlternativeText(text1, text2, text3)
